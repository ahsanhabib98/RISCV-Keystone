...
Network::Network()
{
    ...
    m_Layers_bn = new Layers_Bn(3, 16, 224, 2, "wbdata/conv1.weights", "wbdata/conv1_bn.mean", "wbdata/conv1_bn.variance", "wbdata/conv1_bn.filler",
        "wbdata/conv1_bn.bias_filler");

    m_Layers_ds2_1 = new Layers_Ds(16, 32, 112, 1, "wbdata/conv2_1_dw.weights", "wbdata/conv2_1_bn_dw.mean", "wbdata/conv2_1_bn_dw.variance", "wbdata/conv2_1_bn_dw.filler",
    ...
    m_Layers_ds2_2 = new Layers_Ds(32, 64, 112, 2, "wbdata/conv2_2_dw.weights", "wbdata/conv2_2_bn_dw.mean", "wbdata/conv2_2_bn_dw.variance", "wbdata/conv2_2_bn_dw.filler",
    ...
    m_Layers_ds3_1 = new Layers_Ds(64, 64, 56, 1, "wbdata/conv3_1_dw.weights", "wbdata/conv3_1_bn_dw.mean", "wbdata/conv3_1_bn_dw.variance", "wbdata/conv3_1_bn_dw.filler",
    ...
    m_Layers_ds3_2 = new Layers_Ds(64, 128, 56, 2, "wbdata/conv3_2_dw.weights", "wbdata/conv3_2_bn_dw.mean", "wbdata/conv3_2_bn_dw.variance", "wbdata/conv3_2_bn_dw.filler",
    ...
    m_Layers_ds4_1 = new Layers_Ds(128, 128, 28, 1, "wbdata/conv4_1_dw.weights", "wbdata/conv4_1_bn_dw.mean", "wbdata/conv4_1_bn_dw.variance", "wbdata/conv4_1_bn_dw.filler",
    ...
    m_Layers_ds4_2 = new Layers_Ds(128, 256, 28, 2, "wbdata/conv4_2_dw.weights", "wbdata/conv4_2_bn_dw.mean", "wbdata/conv4_2_bn_dw.variance", "wbdata/conv4_2_bn_dw.filler",
    ...
    m_Layers_ds5_1 = new Layers_Ds(256, 256, 14, 1, "wbdata/conv5_1_dw.weights", "wbdata/conv5_1_bn_dw.mean", "wbdata/conv5_1_bn_dw.variance", "wbdata/conv5_1_bn_dw.filler",
    ...
    m_Layers_ds5_2 = new Layers_Ds(256, 256, 14, 1, "wbdata/conv5_2_dw.weights", "wbdata/conv5_2_bn_dw.mean", "wbdata/conv5_2_bn_dw.variance", "wbdata/conv5_2_bn_dw.filler",
    ...
    m_Layers_ds5_3 = new Layers_Ds(256, 256, 14, 1, "wbdata/conv5_3_dw.weights", "wbdata/conv5_3_bn_dw.mean", "wbdata/conv5_3_bn_dw.variance", "wbdata/conv5_3_bn_dw.filler",
    ...
    m_Layers_ds5_4 = new Layers_Ds(256, 256, 14, 1, "wbdata/conv5_4_dw.weights", "wbdata/conv5_4_bn_dw.mean", "wbdata/conv5_4_bn_dw.variance", "wbdata/conv5_4_bn_dw.filler",
    ...
    m_Layers_ds5_5 = new Layers_Ds(256, 256, 14, 1, "wbdata/conv5_5_dw.weights", "wbdata/conv5_5_bn_dw.mean", "wbdata/conv5_5_bn_dw.variance", "wbdata/conv5_5_bn_dw.filler",
    ...
    m_Layers_ds5_6 = new Layers_Ds(256, 512, 14, 2, "wbdata/conv5_6_dw.weights", "wbdata/conv5_6_bn_dw.mean", "wbdata/conv5_6_bn_dw.variance", "wbdata/conv5_6_bn_dw.filler",
    ...
    m_Layers_ds6 = new Layers_Ds(512, 512, 7, 1, "wbdata/conv6_dw.weights", "wbdata/conv6_bn_dw.mean", "wbdata/conv6_bn_dw.variance", "wbdata/conv6_bn_dw.filler",
    ...
    //m_Convlayer7 = new ConvLayer("wbdata/fc7.weights", 512, 12, 1, 1, 0, 1, 1, "wbdata/fc7.biases");
    m_Fclayer7 = new FcLayer("wbdata/fc7.weights", "wbdata/fc7.biases", 512, 12);
