...
Network::Network()
{
    ...
    m_Layers_bn = new Layers_Bn(3, 8, 224, 2, 1);

    m_Layers_ds2_1 = new Layers_Ds(8, 16, 112, 1, 211, 212);

    m_Layers_ds2_2 = new Layers_Ds(16, 32, 112, 2, 221, 222);

    m_Layers_ds3_1 = new Layers_Ds(32, 32, 56, 1, 311, 312);

    m_Layers_ds3_2 = new Layers_Ds(32, 64, 56, 2, 321, 322);

    m_Layers_ds4_1 = new Layers_Ds(64, 64, 28, 1, 411, 412);

    m_Layers_ds4_2 = new Layers_Ds(64, 128, 28, 2, 421, 422);

    m_Layers_ds5_1 = new Layers_Ds(128, 128, 14, 1, 511, 512);

    m_Layers_ds5_2 = new Layers_Ds(128, 128, 14, 1, 521, 522);

    m_Layers_ds5_3 = new Layers_Ds(128, 128, 14, 1, 531, 532);

    m_Layers_ds5_4 = new Layers_Ds(128, 128, 14, 1, 541, 542);

    m_Layers_ds5_5 = new Layers_Ds(128, 128, 14, 1, 551, 552);

    m_Layers_ds5_6 = new Layers_Ds(128, 256, 14, 2, 561, 562);

    m_Layers_ds6 = new Layers_Ds(256, 256, 7, 1, 61, 62);

    m_Poollayer6 = new GlobalPoolLayer(256, 7);

    //m_Convlayer7 = new ConvLayer("wbdata/fc7.weights", 720, 12, 1, 1, 0, 1, 1, "wbdata/fc7.biases");
    m_Fclayer7 = new FcLayer(7, 256, 12);
