...
//#endif
    ...
    auto *layer1_1 = new sv::ConvLayer<double>(3, 3, 8); //224 x 224 x 64
    network.addLayer(layer1_1);
    auto *layer1_2 = new sv::ConvLayer<double>(8, 3, 8); //224 x 224 x 64
    network.addLayer(layer1_2);
    auto *layer1_3 = new sv::MaxPoolLayer<double>(2, 2); // 112 x 112 x 64
    network.addLayer(layer1_3);
    auto *layer2_1 = new sv::ConvLayer<double>(8, 3, 16); // 112 x 112 x 128
    network.addLayer(layer2_1);
    auto *layer2_2 = new sv::ConvLayer<double>(16, 3, 16); // 112 x 112 x 128
    network.addLayer(layer2_2);
    auto *layer2_3 = new sv::MaxPoolLayer<double>(2, 2); // 56 x 56 x 128
    network.addLayer(layer2_3);
    auto *layer3_1 = new sv::ConvLayer<double>(16, 3, 32); // 56 x 56 x 256
    network.addLayer(layer3_1);
    auto *layer3_2 = new sv::ConvLayer<double>(32, 3, 32); // 56 x 56 x 256
    network.addLayer(layer3_2);
    auto *layer3_3 = new sv::MaxPoolLayer<double>(2, 2); // 28 x 28 x 256
    network.addLayer(layer3_3);
    auto *layer4_1 = new sv::ConvLayer<double>(32, 3, 64); // 28 x 28 x 512
    network.addLayer(layer4_1);
    auto *layer4_2 = new sv::ConvLayer<double>(64, 3, 64); // 28 x 28 x 512
    network.addLayer(layer4_2);
    auto *layer4_3 = new sv::MaxPoolLayer<double>(2, 2); // 14 x 14 x 512
    network.addLayer(layer4_3);
    auto *layer5_1 = new sv::ConvLayer<double>(64, 3, 64); // 14 x 14 x 512
    network.addLayer(layer5_1);
    auto *layer5_2 = new sv::ConvLayer<double>(64, 3, 64); // 14 x 14 x 512
